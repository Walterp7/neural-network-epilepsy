function NetPlot( directory )

%clear all;
E = load( strcat('settings/',directory,'/outputAllNeurons.txt'));
a = load( strcat('settings/',directory,'/outputSpikes.txt'));
figure;
...
for i=1:4 
    plot(1:500,764*i,'--r','Color','red','LineWidth',2);
end
hold off;
subplot(6,1,6);
