...
public class SimChartTheme implements ChartTheme, Cloneable,
	 ...
	 */
	public SimChartTheme(String name) {
		if (name == null) {
			throw new IllegalArgumentException("Null 'name' argument.");
		}
		this.name = name;
		this.extraLargeFont = new Font("Tahoma", Font.BOLD, 24);
		this.largeFont = new Font("Tahoma", Font.BOLD, 20);
		...
		this.drawingSupplier = new SimDrawingSupplier(name);
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SimChartTheme)) {
			return false;
		}
		SimChartTheme that = (SimChartTheme) obj;
