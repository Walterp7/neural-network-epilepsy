...
public class SynapseFactory {
	...
	public SynapseFactory() {
		...
		stdpParams.put("FSII2RSII", new StpParameters(3, 100, 0.000001, 0.5, 0.5274));
		stdpParams.put("FSIV2RSIV", new StpParameters(3, 250, 0.000001, 0.26, 0.2743));
		stdpParams.put("FSV2RSV", new StpParameters(3, 60, 0.000001, 0.6, 0.6329));
		...
		stdpParams.put("FSII2LTSII", new StpParameters(3, 100, 0.000001, 0.4, 0.4219));

		stdpParams.put("LTSII2RSII", new StpParameters(3, 250, 0.000001, 0.3, 0.3165));
		stdpParams.put("LTSIV2RSIV", new StpParameters(2, 70, 60, 0.09, 0.0949));

		stdpParams.put("LTSII2FSII", new StpParameters(3, 100, 0.000001, 0.5, 0.5274));
	...
	public Synapse getSynapse(Neuron preSynaptic, Neuron postSynaptic,
		...
		Synapse newSynapse = new Synapse(weight, preSynaptic, postSynaptic, stp, pspParams);
