...
public class SynapseFactory {
	...
	// 0.5274)); // 5274
	// stdpParams.put("FSIV2RSIV", new StpParameters(3, 250, 0.000001,
	// 0.26,
	// 0.2743)); // 2743
	// stdpParams.put("FSV2RSV", new StpParameters(3, 60, 0.000001, 0.6,
	// 0.6329)); // 6329
	//
	// stdpParams.put("FSII2FSII", new StpParameters(3, 100, 0.000001,
	// 0.5, 0.5274));
	...
	// 0.5274, 0.5274));
	//
	// stdpParams.put("LTSII2LTSII", new StpParameters(3, 600, 1000,
	// 0.09, 0.0949));
	//
