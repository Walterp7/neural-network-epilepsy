...
public class SynapseFactory {
	...
	public SynapseFactory(HashMap<String, StpParameters> params) {
		...
		secondaryPspParams.put("RSLTS", new PSPparameters(0.1, 5, 0.9048, 10));
		...
		secondaryPspParams.put("LTSLTS", new PSPparameters(1, 10, 0.6968, 25));

		secondaryPspParams.put("FSRS", new PSPparameters(1, 15, 0.7692, 30));
		secondaryPspParams.put("FSLTS", new PSPparameters(1, 10, 0.6968, 25));
