...
public class SynapseFactory {
	...
	public SynapseFactory() {
		...
		stdpParams.put("RSII2FSII", new StpParameters(3, 110, 0.000001, 0.2,
				0.2));
		stdpParams.put("RSIV2FSIV", new StpParameters(3, 250, 0.000001, 0.26,
				0.26));
		stdpParams.put("RSVI2FSVI", new StpParameters(2, 70, 100, 0.09,
				0.09));

		stdpParams.put("RSII2LTSII", new StpParameters(3, 150, 200, 0.02,
				0.02));
		stdpParams.put("RSIV2LTSIV", new StpParameters(3, 20, 300, 0.01,
				0.01));

		stdpParams.put("FSII2RSII", new StpParameters(3, 100, 0.000001, 0.5,
				0.5274)); // 5274
		stdpParams.put("FSIV2RSIV", new StpParameters(3, 250, 0.000001, 0.26,
				0.2743)); // 2743
		stdpParams.put("FSV2RSV", new StpParameters(3, 60, 0.000001, 0.6,
				0.6329)); // 6329

		stdpParams.put("FSII2FSII", new StpParameters(3, 100, 0.000001, 0.5,
				0.5274));
		stdpParams.put("FSV2FSV", new StpParameters(3, 80, 0.000001, 0.5,
				0.5274));
		//
		stdpParams.put("FSII2LTSII", new StpParameters(3, 100, 0.000001,
				0.4219, 0.4219)); // 4219

		stdpParams.put("LTSII2RSII", new StpParameters(3, 250, 0.000001,
				0.3165, 0.3165)); // 3165
		stdpParams.put("LTSIV2RSIV", new StpParameters(2, 70, 60, 0.09,
				0.0949)); // 0949

		stdpParams.put("LTSII2FSII", new StpParameters(3, 100, 0.000001,
				0.5274, 0.5274));

		stdpParams.put("LTSII2LTSII", new StpParameters(3, 600, 1000, 0.09,
				0.0949));
